...
#for displaying messagebox at the end of game
...
def get_text(i, j, gb, l1, l2):
	...
	if winner(board, "X"):
		gb.destroy()
		box = messagebox.showinfo("RESULT","Player 1 wins!!!")
	elif winner(board, "O"):
		gb.destroy()
		box = messagebox.showinfo("RESULT","Player 2 wins!!!")
	elif(isfull()):
		gb.destroy()
		box = messagebox.showinfo("RESULT", "Tie Game")
...
def gameboard_pl(game_board, l1, l2):
	...
	for i in range(3):
		...
		for j in range(3):
			...
			button[i][j] = Button(
				game_board, bd=5, command=get_t, height=8, width=15)
...
def get_text_pc(i, j, gb, l1, l2):
	...
	if winner(board, "X"):
		gb.destroy()
		x = False
		box = messagebox.showinfo("RESULT","Player wins!!!")
	elif winner(board, "O"):
		gb.destroy()
		x = False
		box = messagebox.showinfo("RESULT","Computer wins!!!")
	elif(isfull()):
		gb.destroy()
		x = False
		box = messagebox.showinfo("RESULT", "Tie Game")
...
def start():
	menu = Tk()
	menu.geometry("600x640")
	menu.title("Tic Tac Toe")
	wpc = partial(withpc, menu)
	wpl = partial(withplayer, menu)
	
	head = Button(menu, text = "---TIC TAC TOE---",
				activeforeground = 'blue',height=6,
	...
	B2 = Button(menu, text = "MULTI PLAYER", command = wpl, activeforeground = 'blue',
				activebackground = "light blue", bg = "light green", fg = "green",height=6,
